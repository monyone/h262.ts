import BinaryTrie from "./trie.mts";
...
const dct_coefficients_zero_table: [number, number, DCTCefficientsParams][] = [
  ...
  [0b00101,             5, { eob: false, escape: false, run:  0, level:  3}],
  [0b00111,             5, { eob: false, escape: false, run:  3, level:  1}],
  [0b00110,             5, { eob: false, escape: false, run:  4, level:  1}],
  [0b000110,            6, { eob: false, escape: false, run:  1, level:  2}],
  [0b000111,            6, { eob: false, escape: false, run:  5, level:  1}],
  [0b000101,            6, { eob: false, escape: false, run:  6, level:  1}],
  [0b000100,            6, { eob: false, escape: false, run:  7, level:  1}],
  [0b0000110,           7, { eob: false, escape: false, run:  0, level:  4}],
  [0b0000100,           7, { eob: false, escape: false, run:  2, level:  2}],
  [0b0000111,           7, { eob: false, escape: false, run:  8, level:  1}],
  [0b0000101,           7, { eob: false, escape: false, run:  9, level:  1}],
  [0b000001,            6, { eob: false, escape: true }],
  [0b00100110,          8, { eob: false, escape: false, run:  0, level:  5}],
  [0b00100001,          8, { eob: false, escape: false, run:  0, level:  6}],
  [0b00100101,          8, { eob: false, escape: false, run:  1, level:  3}],
  [0b00100100,          8, { eob: false, escape: false, run:  3, level:  2}],
  [0b00100111,          8, { eob: false, escape: false, run: 10, level:  1}],
  [0b00100011,          8, { eob: false, escape: false, run: 11, level:  1}],
  [0b00100010,          8, { eob: false, escape: false, run: 12, level:  1}],
  [0b00100000,          8, { eob: false, escape: false, run: 13, level:  1}],
  [0b0000001010,       10, { eob: false, escape: false, run:  0, level:  7}],
  [0b0000001100,       10, { eob: false, escape: false, run:  1, level:  4}],
  [0b0000001011,       10, { eob: false, escape: false, run:  2, level:  3}],
  [0b0000001111,       10, { eob: false, escape: false, run:  4, level:  2}],
  [0b0000001001,       10, { eob: false, escape: false, run:  5, level:  2}],
  [0b0000001110,       10, { eob: false, escape: false, run: 14, level:  1}],
  [0b0000001101,       10, { eob: false, escape: false, run: 15, level:  1}],
  [0b0000001000,       10, { eob: false, escape: false, run: 16, level:  1}],
  [0b000000011101,     12, { eob: false, escape: false, run:  0, level:  8}],
  [0b000000011000,     12, { eob: false, escape: false, run:  0, level:  9}],
  [0b000000010011,     12, { eob: false, escape: false, run:  0, level: 10}],
  [0b000000010000,     12, { eob: false, escape: false, run:  0, level: 11}],
  [0b000000011011,     12, { eob: false, escape: false, run:  1, level:  5}],
  [0b000000010100,     12, { eob: false, escape: false, run:  2, level:  4}],
  ...
  [0b0000000011010,    13, { eob: false, escape: false, run:  0, level: 12}],
  [0b0000000011001,    13, { eob: false, escape: false, run:  0, level: 13}],
  [0b0000000011000,    13, { eob: false, escape: false, run:  0, level: 14}],
  [0b0000000010111,    13, { eob: false, escape: false, run:  0, level: 15}],
